...
login.addEventListener("click", function(event) {
  if (username.value == "" || pass.value == "")
    ...
    request.addEventListener("load", function() {
      if (request.responseText == "1") window.location = "/profile";
      else if (request.responseText == "-1") window.location = "/deactivate";
      ...
      else if (request.responseText == "update") window.location = "/firstuser";
